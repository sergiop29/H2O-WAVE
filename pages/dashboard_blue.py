...
async def show_blue_dashboard(q: Q):
    ...
    q.page['header'] = ui.header_card(box='header', title='Tela Azul', subtitle='Dashboard Comercial',
    ...
    q.page['title'] = ui.section_card(
        box='title',
        title='Vendas de unidades',
        subtitle="Resultado comercial de cada unidade, acompanhado de seus resultados financeiros",
        items=[
            ui.toggle(name='search', label='Botão', value=True),
    ...
    q.page['total_cost'] = ui.tall_series_stat_card(
        ...
        aux_value='Taxa de prospecções convertidas em vendas',
        plot_type='area',
        plot_color='$blue',
        plot_category='date',
        plot_value='cost',
    ...
    q.page['total_revenue'] = ui.tall_series_stat_card(
        ...
        title='Custos de Vendas',
        value=next(sample_dollars),
        aux_value='Comissões e outros gastos relacionados a uma venda',
        plot_type='area',
        plot_color='$blue',
        plot_category='date',
        plot_value='revenue',
    ...
    q.page['total_profit'] = ui.tall_series_stat_card(
        ...
        title='Margem Bruta',
        value=next(sample_amount),
        aux_value='Taxa de conversão de Receita em Lucro Bruto',
        plot_type='area',
        plot_color='$blue',
        plot_category='date',
        plot_value='profit',
    ...
    q.page['ytd_revenue'] = ui.plot_card(
        ...
        title='Tipos de vendas ao longo do ano',
        data=data(
    ...
    q.page['top_products'] = ui.stat_list_card(
        box='bottom',
        title='Top Produtos',
        subtitle='Receita gerada por categoria de produto',
        items=[
    ...
    q.page['recent_earnings'] = ui.stat_table_card(
        ...
        title='Resultados por Unidade',
        subtitle=next(sample_caption),
        columns=['Unidade', 'Faturamento', 'Margem Bruta', 'Impostos'],
        items=[
            ui.stat_table_item(
    ...
    q.page['footer'] = ui.footer_card(box='footer', caption='(c) 2024 Bravonix. All rights reserved.')
